...
class Juego {
  ...
  void actualizar() {
    ...
    if ( estado.equals( "jugar" ) ) {
      ...
      //jugador.achicar( cenizas );  //COMENTADO PARA DEBUGUEAR COLISIONES 
    }
  }
  ...
  void teclas() {
    ...
    //llamo funcion unica que me permite darle cantidad de pixeles de movimiento
    int m = int(random(20,50));
    //println( m );
    jugador.mover( m );
  }
